"""
Module to fetch data from NYC taxi trips db
and to transform data to time-series format.
"""
...
def download_one_file_of_raw_data(year: int, month: int) -> Path:
    """
    Downloads one file of raw data from the NYC
    taxi trips database.
    """
...
def validate_raw_data(
    ...
    """
    Removes rows with pickup datetime outside
    our desired range.
    """
...
def add_missing_slots(ts_data: pd.DataFrame) -> pd.DataFrame:
    ...
    # move the pickup day from the index to a dataframe column
...
def transform_raw_data_into_ts_data(
    ...
    """
    Get raw NYC trip data and transform into ts data
    """
...
def get_cutoff_indices_features_and_target(
    ...
    """
    Get cut off indices to perform slice and slide transformation.
    """
